...
function start(){
    ...
    if(mark==20){
        ...
        //中飞机
        if(mark1%5==0){         
            enemys.push(new enemy(6,25,window.innerWidth-25,46,60,5000,360,random(1,3),"image/飞机.jpg","image/飞机.jpg"));
        }
        //大飞机
        if(mark1==20){
            enemys.push(new enemy(12,57,window.innerWidth-57,110,164,30000,540,1,"image/飞机2.jpg","image/飞机2.jpg"));
            mark1=0;
        }
        //小飞机
        else{
            enemys.push(new enemy(1,19,window.innerWidth-19,34,24,1000,360,random(1,4),"image/小飞机.jpg","image/小飞机.jpg"));
        }
        mark=0;
    }
